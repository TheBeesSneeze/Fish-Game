...
public partial class @Controls : IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_FishControls_Jump = m_FishControls.FindAction("Jump", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_FishControls_Jump;
    public struct FishControlsActions
    {
        ...
        public InputAction @Jump => m_Wrapper.m_FishControls_Jump;
        ...
        public void SetCallbacks(IFishControlsActions instance)
        {
            if (m_Wrapper.m_FishControlsActionsCallbackInterface != null)
            {
                ...
                @Jump.started -= m_Wrapper.m_FishControlsActionsCallbackInterface.OnJump;
                @Jump.performed -= m_Wrapper.m_FishControlsActionsCallbackInterface.OnJump;
                @Jump.canceled -= m_Wrapper.m_FishControlsActionsCallbackInterface.OnJump;
            }
